        ...
        <div className="relative overflow-x-auto rounded-lg border border-gray-300 shadow-sm bg-white max-w-5xl mx-auto">
          <table className="w-full border-collapse text-xs table-fixed">
            ...
            <tr>
              ...
              <th className="px-4 py-4 text-center sm:text-left font-semibold text-gray-700 uppercase tracking-wider w-2/6">
                Title
              </th>
          ...
          <tbody>
            {pageData.length > 0 ? (
              pageData.map((item, idx) => (
                <tr key={idx} className="hover:bg-blue-50 transition-colors duration-200 border text-[0.65rem]">
